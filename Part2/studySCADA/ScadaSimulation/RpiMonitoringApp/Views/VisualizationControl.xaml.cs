...
namespace SmartHomeMonitoringApp.Views
{
    ...
    public partial class VisualizationControl : UserControl
    {
        ...
        string First_SensingDate = string.Empty;
        ...
        private async void BtnSearch_Click(object sender, RoutedEventArgs e)
        {
            ...
            DataSet ds = new DataSet(); // DB상에 있던 센싱데이터
            ...
            if (DateTime.Parse(DtpStart.Text) < DateTime.Parse(First_SensingDate))
            {
                isValid = false;
                errorMsg += $"검색 시작일은 {First_SensingDate} 부터 가능합니다.\n";
            }

            if (DateTime.Parse(DtpEnd.Text) > DateTime.Now)
            {
                isValid = false;
                errorMsg += "검색 종료일은 금일까지 가능합니다.\n";
            }
            ...
            {
                isValid = false;
                errorMsg += "검색 시작일이 검색 종료일 이후일 수 없습니다.\n";
            }
